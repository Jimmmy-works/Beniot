!(function (t, e) {
  ...
  class b extends f {
    ...
    onChange() {
      ...
      o &&
        "true" !== o &&
        (r = "#" + o + (!a && e.slides.length > 1 ? "-" + (i.index + 1) : "")),
    ...
    onClose() {
      if ((this.timer && clearTimeout(this.timer), !0 !== b.hasSilentClose))
        try {
    ...
    static startFromUrl() {
      if (
        ((b.hasSilentClose = !1), xt.getInstance() || !1 === xt.defaults.Hash)
      )
        return;
      const { hash: t, slug: e, index: i } = b.parseURL();
      if (!e) return;
  ...
  class M {
    constructor(
      ...
      for (const t of [
        ...
        this[t] = this[t].bind(this);
      this.element.addEventListener("mousedown", this.onPointerStart, P),
        this.element.addEventListener("touchstart", this.onTouchStart, P),
        this.element.addEventListener("touchmove", this.onMove, P),
    ...
    onTouchStart(t) {
      for (const e of Array.from(t.changedTouches || []))
        this.triggerPointerStart(new E(e), t);
      window.addEventListener("blur", this.onWindowBlur);
    }
    onMove(t) {
      const e = this.currentPointers.slice(),
        i =
          "changedTouches" in t
            ? Array.from(t.changedTouches || []).map((t) => new E(t))
            : [new E(t)],
        n = [];
      for (const t of i) {
    ...
    onPointerEnd(t) {
      (t.buttons > 0 && 0 !== t.button) ||
        (this.triggerPointerEnd(t, new E(t)),
    ...
    onTouchEnd(t) {
      for (const e of Array.from(t.changedTouches || []))
        this.triggerPointerEnd(t, new E(e));
    }
    ...
    stop() {
      this.element.removeEventListener("mousedown", this.onPointerStart, P),
        this.element.removeEventListener("touchstart", this.onTouchStart, P),
        this.element.removeEventListener("touchmove", this.onMove, P),
  ...
  class B extends m {
    ...
    get isMobile() {
      return (
        null === j &&
          (j = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent)),
        j
      );
    }
    get panMode() {
    ...
    constructor(t, e = {}, i = {}) {
      ...
      if (
        ((this.container = t),
        this.initContent(),
        this.attachPlugins(Object.assign(Object.assign({}, B.Plugins), i)),
        this.emit("init"),
        ...
        if (this.option("spinner")) {
          ...
          t.contains(e)
            ? (this.spinner =
                (null === (s = e.parentElement) || void 0 === s
                  ? void 0
                  : s.insertBefore(i, e)) || null)
            : (this.spinner = t.appendChild(i));
        }
    ...
    initContent() {
      ...
      let e =
        this.option("content") || t.querySelector(`.${this.cn("content")}`);
      if (
        (e ||
          ((e = t.querySelector("img") || t.firstElementChild),
          e && e.classList.add(this.cn("content"))),
        !e)
      )
    ...
    animate() {
      ...
      for (const e of A)
        this.friction
          ? ((this.velocity[e] *= 1 - this.friction),
            t &&
              !this.isScaling &&
              (this.velocity[e] = Math.max(
                Math.min(this.velocity[e], t),
                -1 * t
              )),
            (this.current[e] += this.velocity[e]))
    ...
    onPointerDown(t, e, i) {
      ...
      return (
        ...
        y(this.targetScale, 1e3) === y(this.minScale, 1e3)
          ? (this.stop(),
    ...
    onPointerMove(t, e, i) {
      ...
      if (
        e.length < 2 &&
        this.panOnlyZoomed &&
        y(this.targetScale) <= y(this.minScale)
      )
        return;
      ...
      if (e.length > 1) {
        ...
        (a = s.clientX - t.left - 0.5 * t.width),
          (r = s.clientY - t.top - 0.5 * t.height);
      }
      const l = C(i[0], i[1]),
        c = C(e[0], e[1]);
      let h = l ? c / l : 1,
      ...
      let p =
        y(this.targetScale) === y(this.minScale) && this.option("lockAxis");
      ...
      if (
        (w(t.target, this.content) && ((p = "x"), (this.dragOffset.y = 0)),
        p &&
          "xy" !== p &&
          this.lockedAxis !== p &&
          y(this.targetScale) === y(this.minScale))
      ...
      this.option("rubberband")
        ...
        : (m.xDiff && (d = 0), m.yDiff && (u = 0));
      const f = this.targetScale,
        g = this.minScale,
        b = this.maxScale;
      f < 0.5 * g && (h = Math.max(h, g)),
        f > 1.5 * b && (h = Math.min(h, b)),
        "y" === this.lockedAxis && y(f) === y(g) && (d = 0),
        "x" === this.lockedAxis && y(f) === y(g) && (u = 0),
        this.applyChange({
          originX: a,
          originY: r,
          panX: d,
    ...
    startDecelAnim() {
      this.rAF && (cancelAnimationFrame(this.rAF), (this.rAF = null)),
        ...
        (this.isBouncingY = !1);
      for (const t of A)
        (this.velocity[t] = 0), (this.target[t] = this.current[t]);
      ...
      if (
        ((d < this.minScale - 1e-5 || d > this.maxScale + 1e-5) && (h = 0.35),
        o > 0)
      ) {
        (l = Math.abs(n) > 3 ? n / (o / 30) : 0),
          (c = Math.abs(s) > 3 ? s / (o / 30) : 0);
        const t = this.option("maxVelocity");
        t &&
          ((l = Math.max(Math.min(l, t), -1 * t)),
          (c = Math.max(Math.min(c, t), -1 * t)));
      }
      l && (a = l / (1 / (1 - h) - 1)),
        c && (r = c / (1 / (1 - h) - 1)),
      ...
      Math.abs(u) < m && Math.abs(p) < m && ((a = r = 0), (l = c = 0)),
    ...
    onWheel(t) {
      ...
      if (
        this.prevWheelTime &&
        e - this.prevWheelTime < 200 &&
        this.prevWheelDelta !== i
      )
        return void t.preventDefault();
      if (
        ((this.prevWheelDelta = i),
        (this.prevWheelTime = e),
        this.emit("wheel", t, i),
        "mousemove" === this.panMode)
      )
        return;
      ...
      "pan" === n
        ? (t.preventDefault(),
          (this.panOnlyZoomed && !this.canZoomOut()) ||
            this.applyChange({ panY: 100 * i, bounce: !1 }))
    ...
    setTransform() {
      ...
      for (const i of A) {
        const n = "e" == i || "f" === i ? F : D;
        (s[i] = y(t[i], n)),
          Math.abs(e[i] - t[i]) < ("e" == i || "f" === i ? 0.51 : 0.001) &&
            (this.current[i] = e[i]);
      }
      const { a: o, b: a, c: r, d: l, e: c, f: h } = s,
    ...
    updateMetrics(t = !1) {
      ...
      const { container: e, containerRect: i, content: n } = this,
        s = i.innerWidth,
        o = i.innerHeight,
      ...
      if (
        ...
        (m.style.cssText = f),
        n instanceof HTMLImageElement &&
          ((m.style.width = `${b}px`), (m.style.height = `${v}px`)),
        this.setTransform(),
        !0 !== t)
      ) {
        let t = "";
    ...
    getBounds() {
      ...
      if (!0 === r || (this.lockedAxis && r === this.lockedAxis))
        ...
        let { containerRect: t, contentRect: r } = this,
          l = y(this.contentRect.fitWidth * this.targetScale, F),
          c = y(this.contentRect.fitHeight * this.targetScale, F),
          { innerWidth: h, innerHeight: d } = t;
        if (
          (this.containerRect.width === l && (h = t.width),
          this.containerRect.width === c && (d = t.height),
          e > h)
        ) {
          (o = 0.5 * (e - h)), (n = -1 * o);
        ...
        if (
          (this.contentRect.fitWidth > h &&
            e < h &&
            ((n -= 0.5 * (this.contentRect.fitWidth - h)),
        ...
        this.contentRect.fitHeight > d &&
          i < d &&
          ((n -= 0.5 * (this.contentRect.fitHeight - d)),
    ...
    updateControls() {
      ...
      let i =
        ...
        o = "drag" === this.panMode,
        a = s && o;
      this.targetScale <= this.minScale && !this.panOnlyZoomed && (a = !0),
        (this.contentRect.width - this.contentRect.fitWidth > -1 ||
          this.contentRect.height - this.contentRect.fitHeight > -1) &&
          (a = !0),
        this.contentRect.width * this.targetScale < this.contentRect.fitWidth &&
          (a = !1),
        "mousemove" === this.panMode && (a = !1);
      let r = n && y(i) > y(this.targetScale),
        l = !r && !a && s && y(i) < y(this.targetScale);
      S(e, this.cn("canZoomIn"), r),
        S(e, this.cn("canZoomOut"), l),
        S(e, this.cn("isDraggable"), a);
      ...
      for (const i of e.querySelectorAll(
        ...
        (n = t.targetScale < t.fullScale - 0.1),
          n || s
        ...
        e &&
          (e.style.display = t.targetScale > 0.9 * t.fullScale ? "none" : "");
      }
    }
    panTo({
      x: t = this.target.e,
    ...
    applyChange({
      ...
      (g = g.translate(-s, -o).translate(-p, -m).multiply(f)),
        n && (g = g.rotate(n)),
        r && (g = g.scale(-1, 1)),
        l && (g = g.scale(1, -1));
      for (const t of A)
      ...
      (this.targetScale < this.scale ||
        ...
        this.isResting || ((this.state = O.Panning), this.requestTick());
    }
    stop(t = !1) {
    ...
    panWithMouse(t, e = this.option("mouseMoveFriction")) {
      if (((this.prevMouseMoveEvent = t), "mousemove" !== this.panMode || !t))
        return;
      ...
      let m = 0.5 * (d - a) - (((c / a) * 100) / 100) * (d - a);
      (m += 0.5 * (s.bottom - s.top)),
        this.applyChange({
    ...
    zoomWithWheel(t) {
      ...
      let a = (n * (100 + i * e)) / 100;
      a < o && n <= o
        ? ((this.wheelDelta += Math.abs(i)), (a = o))
        : a > s && n >= s
        ? ((this.wheelDelta += Math.abs(i)), (a = s))
        : ((this.wheelDelta = 0), (a = Math.max(Math.min(a, s), o))),
        this.wheelDelta > this.option("wheelLimit") ||
          (t.preventDefault(), a !== n && this.zoomTo(a, { event: t }));
    }
    canZoomIn() {
      return (
        this.option("zoom") &&
        (this.contentRect.width < this.contentRect.fitWidth ||
          this.targetScale < this.maxScale - 1e-5)
      );
    }
    canZoomOut() {
    ...
    zoomTo(
      ...
      let a = 1;
      if (
        ("mousemove" === this.panMode && (s = this.prevMouseMoveEvent || s), s)
      ) {
  ...
  class N extends f {
    ...
    onClose() {
      ...
      if (!r) return;
      (this.instance.state = h.CustomClosing),
      ...
      const { x: c, y: d, scale: u, opacity: p } = r;
      if (p) {
        const t = ((t, e, i, n) => {
          const s = e - t,
            o = n - i;
      ...
      return new Promise((e, i) => {
        ...
        const { x: r, y: l, scale: c, opacity: h } = a,
          ...
          p = (t) => {
            t.scale < 0.99 ||
              ...
              t.off("touchStart", p),
              t.off("afterTransform", u),
              e(t));
          };
        n.on("endAnimation", p),
          n.on("touchStart", p),
          n.on("afterTransform", u),
          n.on(["error", "destroy"], () => {
            i();
          }),
        ...
        const m = this.instance,
          f = {
            event:
              "mousemove" === n.panMode
                ? m.prevMouseMoveEvent || m.options.event
                : void 0,
          },
    ...
    getZoomInfo(t) {
      ...
      let { top: c, left: d, fitWidth: u, fitHeight: p } = s.contentRect;
      if (!(r && l && u && p)) return !1;
      const m = r / u,
        f = s.container.getBoundingClientRect();
      (c += f.top), (d += f.left);
      const g = -1 * (d + 0.5 * u - (a + 0.5 * r)),
        b = -1 * (c + 0.5 * p - (o + 0.5 * l));
      let v = this.option("zoomOpacity") || !1;
      return (
        "auto" === v && (v = Math.abs(r / l - u / p) > 0.1),
        { x: g, y: b, scale: m, opacity: v }
      );
    }
    attach() {
      this.instance.on("Carousel.change", this.onChange),
  ...
  class Y extends f {
      ...
      if (e) {
        if ("clone" === t.type || e.dataset.placeholderId) {
          ...
          i && (e.classList.remove(i), delete e.dataset.animationName),
            delete e.dataset.placeholderId;
    ...
    processType(t) {
      ...
      if (
        ...
        (t.videoId = o),
          (t.src = `https://www.youtube-nocookie.com/embed/${o}?${s}`),
          (t.thumbSrc =
            t.thumbSrc || `https://i.ytimg.com/vi/${o}/mqdefault.jpg`),
          (i = "youtube");
      } else if ((n = e.match(/^.+vimeo.com\/(?:\/)?([\d]+)(.*)?/))) {
        const s = W(e, this.optionFor(t, "vimeo")),
          o = encodeURIComponent(n[1]);
        (t.videoId = o),
          (t.src = `https://player.vimeo.com/video/${o}?${s}`),
          (i = "vimeo");
      }
      if (!i && t.triggerEl) {
  ...
  let U = class extends f {
    ...
    getProgress(t) {
      ...
      let s = -1 * i.current.e,
        ...
        l = (s - o - n.pos) / (1 * n.dim);
      return (
        (a = Math.max(0, Math.min(1, Math.abs(a)))),
        (r = Math.max(0, Math.min(1, Math.abs(r)))),
        (l = Math.max(0, Math.min(1, Math.abs(l)))),
        (a = Math.min(a, r, l)),
        a
      );
    }
    ...
    onTransformM() {
      ...
      for (const e of t.slides) {
        ...
        if (!i) continue;
        (o = 0),
          S(i, this.cn("isSelected"), t === this.instance.page),
          (o = 1 - this.getProgress(t)),
          i.style.setProperty("--progress", o ? o + "" : "");
        const n = 0.5 * ((e.thumbWidth || 0) - this.thumbClipWidth);
        (s += n),
          o && (s -= o * (n + this.thumbExtraGap)),
          i.style.setProperty("--shift", s + ""),
          (s += n),
          o && (s -= o * (n + this.thumbExtraGap)),
          (s -= this.thumbGap),
          0 === t && (a = this.thumbExtraGap * o);
      }
      i &&
        (i.style.setProperty("--left", a + ""),
        i.style.setProperty(
          "--width",
          s + a + this.thumbGap + this.thumbExtraGap * o + ""
        )),
    ...
    buildModern() {
      ...
      for (const t of i.slides || []) {
        ...
        i.appendChild(n(this.formatThumb(t, s))),
          (t.thumbSlideEl = i),
          e.appendChild(i),
        ...
        for (const s of t.slides || []) {
          ...
          t.appendChild(u),
            o.addEventListener(
              ...
              () => {
                t.offsetParent &&
                  (t.classList.remove(this.cn("isLoading")), u.remove());
              },
              !1
            );
        }
    ...
    getModernThumbPos(t) {
      ...
      let o =
        ...
        this.thumbExtraGap +
        0.5 * (e.thumbWidth || 0);
      return (o -= s > n ? 0.5 * n : 0.5 * s), y(o || 0, 1);
    }
    build() {
      const t = this.instance,
        e = t.container,
  ...
  class J extends f {
    ...
    onInit() {
      ...
      n &&
        ...
        e.attachPlugins({ Thumbs: U }),
        (this.ref = e.plugins.Thumbs),
        this.option("showOnStart") ||
          ((this.ref.state = G.Hidden), (this.hidden = !0)));
    }
    onResize() {
      var t;
  ...
  class pt extends f {
    ...
    createButton(t) {
      ...
      i.setAttribute("tabindex", "0"),
        ...
        k(
          i,
          this.cn("button") + " " + this.cn("next" === t ? "isNext" : "isPrev")
        );
  ...
  class mt extends f {
    ...
    attachEvents() {
      this.nav &&
        ...
        this.nav.state === lt.Ready && this.onNavReady(this.nav),
        this.target.on("ready", this.onTargetReady),
        this.target.state === lt.Ready && this.onTargetReady(this.target));
    }
    onNavReady(t) {
  ...
  const ft = { Navigation: pt, Dots: ut, Sync: mt };
  class gt extends m {
    get axis() {
    ...
    get isInfinite() {
      ...
      const e = this.contentDim,
        i = this.viewportDim;
      return (
        this.pages.length >= 2 && e > 1.5 * i && (t = this.option("infinite")),
        t
      );
    }
    get isRTL() {
    ...
    constructor(t, e = {}, i = {}) {
      if (
        ...
        throw new Error("No Element found");
      (this.container = t),
        (this.slideNext = ot(this.slideNext.bind(this), 150)),
        (this.slidePrev = ot(this.slidePrev.bind(this), 150)),
        (this.userOptions = e),
        (this.userPlugins = i),
        queueMicrotask(() => {
          this.processOptions();
    ...
    processOptions() {
      ...
      if (s && e(s))
        for (const [o, a] of Object.entries(s))
          window.matchMedia(o).matches && e(a) && ((n += o), i(t, a));
      (n === this.bp && this.state !== lt.Init) ||
        ((this.bp = n),
        this.state === lt.Ready &&
          (t.initialSlide = this.pages[this.page].slides[0].index),
        this.state !== lt.Init && this.destroy(),
        super.setOptions(t),
    ...
    init() {
      (this.state = lt.Init),
        this.emit("init"),
        this.attachPlugins(
          Object.assign(Object.assign({}, gt.Plugins), this.userPlugins)
        ),
        this.initLayout(),
        this.initSlides(),
        this.updateMetrics(),
    ...
    initLayout() {
      ...
      k(t, this.cn("container")),
        S(t, e.isLTR, !this.isRTL),
        S(t, e.isRTL, this.isRTL),
        S(t, e.isVertical, !this.isHorizontal),
        S(t, e.isHorizontal, this.isHorizontal);
      let i = this.option("viewport") || t.querySelector(`.${e.viewport}`);
      i ||
        ((i = document.createElement("div")),
        k(i, e.viewport),
        i.append(...at(t, `.${e.slide}`)),
        t.prepend(i));
    ...
    initSlides() {
      ...
      if (t) {
        (this.slides = []),
          [...at(t, `.${this.cn("slide")}`)].forEach((t) => {
            if (z(t)) {
              const e = ct({ el: t, isDom: !0, index: this.slides.length });
              this.slides.push(e),
    ...
    createPages() {
      ...
      if ("number" == typeof n && e > i) {
        for (let e = 0; e < this.slides.length; e += n)
          t.push(ht({ index: e, slides: this.slides.slice(e, e + n) }));
        return t;
      }
      let s = 0,
        o = 0;
    ...
    processPages() {
      ...
      if (
        ...
        t.forEach((t, n) => {
          s &&
            !this.isInfinite &&
            e > i &&
            ((t.pos = Math.max(t.pos, 0)), (t.pos = Math.min(t.pos, e - i))),
            (t.pos = y(t.pos, 1e3)),
            (t.dim = y(t.dim, 1e3)),
      ...
      return (
        t.forEach((t) => {
          ...
          r && e.pos === r.pos
            ? ((r.dim += e.dim), (r.slides = [...r.slides, ...e.slides]))
    ...
    getSlideMetrics(t) {
      ...
      return (
        ...
        (n =
          parseFloat(o[this.isHorizontal ? "marginRight" : "marginBottom"]) ||
          0),
        this.isHorizontal,
        t.el || s.remove(),
        { dim: y(i, 1e3), gap: y(n, 1e3) }
      );
    }
    getBounds() {
      let t = { min: 0, max: 0 };
      ...
      return {
        x: this.isHorizontal ? t : { min: 0, max: 0 },
        y: this.isHorizontal ? { min: 0, max: 0 } : t,
      };
    }
    repositionSlides() {
      const { viewportDim: t, contentDim: e, page: i, pages: n } = this;
      let s,
        o = 0,
        a = 0,
        r = 0,
        l = 0;
      this.panzoom
        ? (l = -1 * this.panzoom.current[this.isHorizontal ? "e" : "f"])
        : n[i] && (l = n[i].pos || 0),
        (s = this.isHorizontal ? (this.isRTL ? "right" : "left") : "top"),
      ...
      if (this.isInfinite && r)
        for (const i of this.slides)
          i.el &&
            (y(i.pos) < y(t) &&
              y(i.pos + i.dim + i.gap) < y(l) &&
              y(l) > y(e - t) &&
              (i.el.style[s] = `${y(a + r, 1e3)}px`),
            y(i.pos + i.gap) >= y(e - t) &&
              y(i.pos) > y(l + t) &&
              y(l) < y(t) &&
              (i.el.style[s] = `-${y(r, 1e3)}px`));
      let c,
        h,
        d = [...this.inTransition];
      if (
        (d.length > 1 && ((c = this.pages[d[0]]), (h = this.pages[d[1]])),
        c && h)
      ) {
        let t = 0;
        for (const e of this.slides)
          e.el
            ? this.inTransition.has(e.index) &&
              c.slides.indexOf(e) < 0 &&
              (e.el.style[s] = `${y(t + (c.pos - h.pos), 1e3)}px`)
            : (t += e.dim + e.gap);
      }
    }
    createSlideEl(t) {
    ...
    removeSlideEl(t, e = !1) {
      const i = t.el;
      if (!i) return;
      if ((R(i, this.cn("isSelected")), t.isDom && !e))
        return void (i.style.left = "");
    ...
    transitionTo(t = 0, e = this.option("transition")) {
      ...
      if (this.page === s && y(a, 1e3) === y(n.target[this.axis], 1e3))
        return !1;
          ...
          i.el &&
            ...
            this.pages[this.page].slides.includes(i)
              ? (i.el.classList.contains(e) ||
                  (k(i.el, e), this.emit("selectSlide", i)),
                i.el.removeAttribute(t))
              : (i.el.classList.contains(e) &&
                  (R(i.el, e), this.emit("unselectSlide", i)),
        ...
        (e.src = e.dataset.lazySrcset || e.dataset.lazySrc || ""),
          ...
          setTimeout(() => {
            e.parentNode &&
              ...
              (e.complete
                ? o(t, e, i)
                : ((i = n(r)), e.parentNode.insertBefore(i, e)));
          }, 300);
      }
    ...
    onAnimationEnd(t) {
      ...
      o &&
        s.substring(0, o.length + 2) === `f-${o}` &&
        this.inTransition.delete(i),
        this.inTransition.size || this.clearTransitions(),
        i === this.page && this.emit("settle");
    }
    onDecel(t, e = 0, i = 0, n = 0, s = 0) {
      ...
      const p = t.target[r] * (this.isRTL && a ? 1 : -1),
        { pageIndex: m } = this.getPageFromPosition(p),
        f = t.current[r] * (o && a ? 1 : -1);
      let { page: g } = this.getPageFromPosition(f);
      d
        ? this.onChange(m)
        : (Math.abs(h) > 5
            ? (Math.max(Math.abs(n), Math.abs(s)) >
                this.pages[u].slides[0].dim &&
                (console.log(`yes? targetPage: ${m}; currentPage: ${g}`),
                (u = g)),
    ...
    onRefresh(t, e = "") {
      let i = this.contentDim,
        n = this.viewportDim;
      this.updateMetrics(),
        (this.contentDim === i && this.viewportDim === n) ||
    ...
    slideTo(
      ...
      if (this.isInfinite) {
        const t = n.current[o] * (this.isRTL && this.isHorizontal ? 1 : -1),
          ...
          i = r + e,
          s = r - e;
        Math.abs(t - i) < Math.abs(t - r) && ((r = i), (l = 1)),
          Math.abs(t - s) < Math.abs(t - r) && ((r = s), (l = -1));
      }
    ...
    updateMetrics() {
      ...
      for (const [t, e] of this.slides.entries()) {
        ...
        !e.el && i
          ? ((n = i.dim), (o = i.gap))
          : (({ dim: n, gap: o } = this.getSlideMetrics(e)), (i = e)),
          (n = y(n, 1e3)),
          (o = y(o, 1e3)),
          (e.dim = n),
          (e.gap = o),
          (e.pos = s),
          (s += n),
          (this.isInfinite || t < this.slides.length - 1) && (s += o);
      }
      this.viewport &&
        (this.viewportDim = y(this.viewport.getBoundingClientRect()[e], 1e3));
      const o = this.contentDim;
      (this.contentDim = s),
        t &&
          ((t.contentRect[e] = s),
          (t.contentRect["e" === this.axis ? "fullWidth" : "fullHeight"] = s)),
        (this.pages = this.createPages()),
        (this.pages = this.processPages()),
        this.state === lt.Init && this.setInitialPage(),
  ...
  class xt extends m {
    ...
    initLayout() {
      ...
      e &&
        ...
        e.classList.toggle("is-compact", this.isCompact),
        k(e, this.option("mainClass") || ""),
        (this.container = e),
        ...
        (bt && vt) ||
          ...
          bt.classList.add("fancybox-focus-guard"),
        ...
        this.option("dragToClose") &&
          (s.on("Panzoom.afterTransform", (t, e) => {
            ...
            if (i) {
              ...
              i.style.setProperty("--fancybox-ts", n ? "0s" : ""),
                i.style.setProperty("--fancybox-opacity", n + "");
            }
          }),
          s.on("Panzoom.touchEnd", (t, e, i) => {
            ...
            "y" === e.lockedAxis &&
              ...
              this.close(i, "f-throwOut" + (e.current.f < 0 ? "Up" : "Down")));
          })),
        s.on(["change"], (t) => {
          var e;
          let i =
    ...
    onWheel(t) {
      const e = t.wheelDeltaY
          ? t.wheelDeltaY === -3 * t.deltaY
          : 0 === t.deltaMode,
        i = Date.now();
      if (this.prevWheelTime && i - this.prevWheelTime < (e ? 600 : 300))
        return void t.preventDefault();
      if (((this.prevWheelTime = i), this.emit("wheel", t), t.defaultPrevented))
        return;
      ...
      if ("close" === n) t.preventDefault(), this.close(t);
        ...
        t.preventDefault();
        this[
          Math.max(-1, Math.min(1, -t.deltaY || -t.deltaX || -t.detail)) > 0
            ? "prev"
            : "next"
        ]();
      }
      ...
      if (
        ...
        for (const t of (null === (e = this.carousel) || void 0 === e
          ...
          t.captionEl &&
            ...
            null === (i = t.el) ||
              void 0 === i ||
              i.classList.remove("has-caption"),
            null === (n = t.el) ||
              void 0 === n ||
      ...
      if (a) {
        if (((c = t.captionEl || null), r && !c)) {
          ...
          (c = document.createElement("div")),
            (c.className = "fancybox__caption"),
            c.setAttribute("id", e),
            (t.captionEl = r.appendChild(c)),
            r.classList.add("has-caption"),
            r.setAttribute("aria-labelledby", e);
        }
      } else {
        if (
          ((c = this.caption),
          c || (c = s.querySelector(".fancybox__caption")),
          !c)
        ) {
          (c = document.createElement("div")),
      ...
      t
        ? (!n || u.indexOf(n) < 0) &&
          ...
          u.length &&
            (i === vt
              ? (m = u[0])
              : (this.lastFocus !== r && i !== bt) || (m = u[u.length - 1])))
        : this.option("autoFocus") && (m = p),
        m &&
          ((t) => {
            if (t && s) {
              void 0 === o &&
    ...
    isTopmost() {
      var t;
      return (
        (null === (t = xt.getInstance()) || void 0 === t ? void 0 : t.id) ==
        this.id
      );
    }
    animate(t = null, e = "", i) {
    ...
    setContent(t, e = "", i = !0) {
      ...
      let s = null;
      if (z(e))
        ["img", "iframe", "video", "audio"].includes(e.nodeName.toLowerCase())
    ...
    revealContent(t, e) {
      ...
      this.isClosing() ||
        ((t.state = d.Ready),
        this.emit("done", t),
        null === (e = t.el) || void 0 === e || e.classList.add("is-done"),
    ...
    hideLoading(t) {
      ...
      this.isClosing()
        ...
        : (e.classList.remove("is-loading"),
          ...
          t.state === d.Loading &&
            (this.emit("loaded", t), (t.state = d.Ready)));
    }
    setError(t, e) {
      if (this.isClosing()) return;
      this.emit("error"),
      ...
      if (a) {
        const t = this.option("placeFocusBack")
          ? (null === (i = this.getSlide()) || void 0 === i
              ? void 0
              : i.triggerEl) || this.option("trigger")
          : null;
        t && t.focus();
      }
      if (
        (s &&
          ...
          this.option("animated") && k(s, "is-animated"),
          (s.style.pointerEvents = "none")),
        o)
      ) {
        o.clearTransitions(),
          null === (n = o.panzoom) || void 0 === n || n.destroy();
    ...
    static unbind(t, e) {
      ...
      s && n && s.delete(n),
        (n && s) ||
          (xt.openers.delete(i), i.removeEventListener("click", xt.fromEvent));
    }
    static destroy() {
      let t;
      for (; (t = xt.getInstance()); ) t.destroy();
      for (const t of xt.openers.keys())
        t.removeEventListener("click", xt.fromEvent);
      xt.openers = new Map();
    }
    static fromEvent(t) {
      if (t.defaultPrevented) return;
      ...
      if (
        ((!e || p || d) && (l = [].slice.call(s.querySelectorAll(o))),
        e &&
          !d &&
          (l = p ? l.filter((t) => t.getAttribute(`${u}`) === p) : [e]),
        !l.length)
      )
        return;
      const m = xt.getInstance();
      return m && m.options.trigger && l.indexOf(m.options.trigger) > -1
        ? void 0
        : (e && (h.startIndex = l.indexOf(e)), xt.fromNodes(l, h));
    }
          ...
          o ||
            (o =
              i instanceof HTMLImageElement
                ? i
                : i.querySelector("img:not([aria-hidden])")),
          o &&
    ...
    static getSlide() {
      var t;
      return (
        (null === (t = xt.getInstance()) || void 0 === t
          ? void 0
          : t.getSlide()) || null
      );
    }
